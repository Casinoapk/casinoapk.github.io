class SiteEngine {
    constructor() {
        ...
        this.currentCarouselIndex = 0; // Initialize the index
    ...
    cacheCSS() {
        this.cache.css.main = `
            :root {
                --primary-color: #9b59b6; /* Purple - magic */
                --secondary-color: #e74c3c; /* Red - energy */
                --accent-color: #f1c40f; /* Yellow - fun */
                --text-color: #2c3e50; /* Dark blue - contrast */
                --light-color: #ecf0f1; /* Light gray */
                --dark-color: #34495e; /* Dark blue */
                --magic-color: #1abc9c; /* Turquoise - magic */
